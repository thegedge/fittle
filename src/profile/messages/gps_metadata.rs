            ...
            Reader: ReadBytesExt,
    {
        ...
        for field in fields {
            ...
            match number {
                ...
                4 => msg.enhanced_speed = content.one().map(|v| crate::fields::Velocity::new::<uom::si::velocity::meter_per_second, f64>((|v| { <f64>::from(<u32>::from(v)) / 1000.0 - 0.0 })(v))),
                ...
                7 => msg.velocity = content.many().map(|vec| vec.into_iter().map(|v| crate::fields::Velocity::new::<uom::si::velocity::meter_per_second, f64>((|v| { <f64>::from(<i16>::from(v)) / 100.0 - 0.0 })(v))).collect()),
