            ...
            Reader: ReadBytesExt,
    {
        ...
        for field in fields {
            ...
            match number {
                ...
                53 => msg.avg_pos_vertical_speed = content.one().map(|v| { <f64>::from(<i16>::from(v)) / 1000.0 - 0.0 }),
                54 => msg.avg_neg_vertical_speed = content.one().map(|v| { <f64>::from(<i16>::from(v)) / 1000.0 - 0.0 }),
                55 => msg.max_pos_vertical_speed = content.one().map(|v| { <f64>::from(<i16>::from(v)) / 1000.0 - 0.0 }),
                56 => msg.max_neg_vertical_speed = content.one().map(|v| { <f64>::from(<i16>::from(v)) / 1000.0 - 0.0 }),
                ...
                77 => msg.avg_vertical_oscillation = content.one().map(|v| { <f64>::from(<u16>::from(v)) / 10.0 - 0.0 }),
                78 => msg.avg_stance_time_percent = content.one().map(|v| { <f64>::from(<u16>::from(v)) / 100.0 - 0.0 }),
                79 => msg.avg_stance_time = content.one().map(|v| { <f64>::from(<u16>::from(v)) / 10.0 - 0.0 }),
                80 => msg.avg_fractional_cadence = content.one().map(|v| { <f64>::from(<u8>::from(v)) / 128.0 - 0.0 }),
                81 => msg.max_fractional_cadence = content.one().map(|v| { <f64>::from(<u8>::from(v)) / 128.0 - 0.0 }),
                ...
                110 => msg.enhanced_avg_speed = content.one().map(|v| { <f64>::from(<u32>::from(v)) / 1000.0 - 0.0 }),
                111 => msg.enhanced_max_speed = content.one().map(|v| { <f64>::from(<u32>::from(v)) / 1000.0 - 0.0 }),
                ...
                120 => msg.avg_step_length = content.one().map(|v| { <f64>::from(<u16>::from(v)) / 10.0 - 0.0 }),
                121 => msg.avg_vam = content.one().map(|v| { <f64>::from(<u16>::from(v)) / 1000.0 - 0.0 }),
